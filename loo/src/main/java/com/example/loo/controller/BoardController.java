...
public class BoardController {
	...
	@GetMapping("read")
	public String read(@RequestParam Long board_id, @RequestParam(required = false) Long comment_id, Model model) {
	...
	public String writeComment(@SessionAttribute(value = "loginMember", required = false) Member loginMember,
			@ModelAttribute("newComment") CommentsWrite commentsWrite, @RequestParam Long board_id,
			@RequestParam BoardCategory board_category, BindingResult results) {
	...
	public String updateComment(@SessionAttribute(value = "loginMember", required = false) Member loginMember,
			@RequestParam Long comment_id, @RequestParam BoardCategory board_category, Model model) {
	...
	public String updateComment(@SessionAttribute(value = "loginMember", required = false) Member loginMember,
			@RequestParam Long comment_id, @RequestParam BoardCategory board_category,
			@Validated @ModelAttribute("updateComment") CommentsUpdate commentsUpdate, BindingResult result) {
	...
	public String deleteComment(@SessionAttribute(value = "loginMember", required = false) Member loginMember,
			@RequestParam BoardCategory board_category, @RequestParam Long comment_id) {
